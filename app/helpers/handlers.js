...
const showPostPage = (currentQuestion, request, h) => {
  ...
  if (
    ...
    getYarValue(request, 'applyingFor') === 'Building a new store, replacing or expanding an existing store' || getYarValue(request, 'applyingFor') === 'An impermeable cover only') {
