  ...
  sections: [
    {
      ...
      questions: [
          ...
          validate: [
            {
              type: "NOT_EMPTY",
              error:
                "Select yes if the land has a tenancy agreement in place for 5 years after the final grant payment.",
            },
          ],
          answers: [
            {
        ...
        },
        {
          ...
          answers: [
            ...
            },
            {
              ...
              value:
                "Not yet applied for but expected to be in place by 31 December 2023",
        ...
        },
        {
          ...
          ineligibleContent: {
            messageContent:
              "The land must be owned by the applicant, or there must be a tenancy in place to at least 2026, before the project starts.",
            messageLink: {
              url: "https://www.gov.uk/topic/farming-food-grants-payments/rural-grants-payments",
              title: "See other grants you may be eligible for.",
            },
        ...
        },
        {
          ...
          answers: [
            ...
            },
            {
              ...
              value:
                "A Long term lease (to at least 2026) is, or will be, in place before the project starts",
            },
            {
              key: "project-location-owned-rented-A4",
              value:
                "A long-term lease will not be in place before project start",
              notEligible: true,
            },
          ],
        ...
        },
        {
          ...
          ineligibleContent: {
            messageContent:
              "You can only apply for a grant of up to 40% of the estimated costs.",
            insertText: {
              text: "The minimum grant you can apply for is £25,000 (40% of £62,500). The maximum grant is £300,000.",
            },
            messageLink: {
              url: "https://www.gov.uk/topic/farming-food-grants-payments/rural-grants-payments",
              title: "See other grants you may be eligible for.",
        ...
        },
        {
          ...
          order: 200,
          title:
            "Will you work in partnership or collaborate with other farmers or producers?",
          hint: {
          ...
          fundingPriorities:
            "Improve processing and supply chains<br/><br/>Encourage collaboration and partnerships",
          type: "single-answer",
          minAnswerCount: 1,
          validate: [
            {
              type: "NOT_EMPTY",
              error:
                "Select yes if you will be buying materials from other farmers",
            },
          ],
          answers: [
            {
