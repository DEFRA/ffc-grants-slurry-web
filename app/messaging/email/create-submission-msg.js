...
function getEmailDetails (submission, rpaEmail, isAgentEmail = false) {
  ...
  const result = {
    ...
    details: {
      ...
      existingGridReference: gridReference.existingGridReference.replace(/\s/g, '').toUpperCase(),
      newGridReference: gridReference.newGridReference.replace(/\s/g, '').toUpperCase(),
