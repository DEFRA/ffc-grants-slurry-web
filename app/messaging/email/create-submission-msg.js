    ...
    worksheets: [
      {
        ...
        rows: [
          ...
          generateRow(341, 'Grant Launch Date', (new Date('2024-07-11')).toLocaleDateString('en-GB')),
          ...
          generateRow(402, 'Existing store OS grid reference', gridReference.existingGridReference),
          generateRow(521, 'New store OS grid reference', gridReference.newGridReference),
          ...
          generateRow(85, 'Full Application Submission Date', (new Date('2026-03-31')).toLocaleDateString('en-GB')),
...
function getEmailDetails (submission, rpaEmail, isAgentEmail = false) {
  ...
  const result = {
    ...
    details: {
      ...
      existingGridReference: gridReference.existingGridReference,
      newGridReference: gridReference.newGridReference,
