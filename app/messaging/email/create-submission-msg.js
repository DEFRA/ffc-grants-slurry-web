...
console.log(submission, 'SUBMISSION')
  ...
  return {
    ...
    details: {
      ...
      existingStoreCoverType: applyingFor === 'An impermeable cover only' && fitForPurpose === 'No' || grantFundedCover === 'Yes, I already have a cover' || grantFundedCover === 'Not needed, the slurry is treated with acidification' || existingCover === 'No' ? ' ' : existingCoverType,
      existingStoreCoverTypeTrue: applyingFor === 'An impermeable cover only' && fitForPurpose === 'No' || grantFundedCover === 'Yes, I already have a cover' || grantFundedCover === 'Not needed, the slurry is treated with acidification' || existingCover === 'No' ? 'false' : 'true',
      ...
      existingStoreCoverSize: applyingFor === 'An impermeable cover only' && fitForPurpose === 'No' || grantFundedCover === 'Yes, I already have a cover' || grantFundedCover === 'Not needed, the slurry is treated with acidification' || existingCover === 'No' ? '' : existingCoverSize + 'm²',
