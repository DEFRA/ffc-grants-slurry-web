Feature: Grant Application

    Scenario: Successfully apply for a Slurry Infrastructure R3 grant
        # login/start
        ...
        And enters "SP 83498 61506" in "newGridReference"
        And continues
        ...
        Then a spreadsheet should be generated with the following values
            ...
            | 44     | Project Items                                        | Above-ground steel slurry store~1000\|Fixed flexible cover~100\|Fixed flexible cover~50\|Roller screen press~1\|Gantry~1\|Concrete pad~1\|Reception pit~100~m³ |                  |
            | 45     | Location of project (postcode)                       | NN7 2NN                                                                                                                                                        |                  |
            | 53     | Business type                                        | Pig Farmer                                                                                                                                                     |                  |
            | 54     | Electronic OA received date                          | ?                                                                                                                                                              | CURRENT-DATE     |
            | 55     | Total project expenditure                            | 174741.00                                                                                                                                                      |                  |
            | 56     | Grant amount requested                               | 87370.5                                                                                                                                                        | DECIMAL          |
            | 57     | Grant rate                                           | 50                                                                                                                                                             |                  |
            ...
            | 521    | New store OS grid reference                          | SP8349861506                                                                                                                                                   |                  |